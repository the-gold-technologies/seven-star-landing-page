  ...
  const defaultCards: CelebrateCard[] = [
    {
      ...
      link: "https://www.opentable.co.uk/r/the-seven-stars-at-marsh-baldon-reservations-oxford?restref=459243&lang=en-GB&ot_source=Restaurant%20website",
      label: "Plan your party",
    },
    {
      image: "/Christmas/ChristmasImageNew.jpg",
      alt: "Christmas Day table setting with candles and a decorated tree",
      title: "Christmas Festive & Day",
      text: "Christmas Day at Seven Stars: candlelight, a warm room, and a menu made for the one day of the year that deserves it.",
      link: "/Christmas/ChristmasMenu.pdf",
      label: "Christmas Festive & Day menu",
    },
    {
